...
<html>
    ...
    <body>
        ...
        <h1 class="header">Trainer Update Form</h1>
        <div class="container my-5">
            <form action="trainer/doupdate" method="post">
                <input type="hidden" name="trainerId" value="${trainertoupdate.trainerId}"/>
                <div class="form-group">
                    <label for="firstNameInput">First Name</label>
                    <input type="text" name="firstname" class="form-control" id="firstNameInput" value="${trainertoupdate.firstname}"/>
                </div>
                <div class="form-group">
                    <label for="lastNameInput">Last Name</label>
                    <input type="text" name="lastname" class="form-control" id="lastNameInput" value="${trainertoupdate.lastname}"/>  
                </div>
                <div class="form-group">
                    <label for="subjectInput">Subject</label>
                    <input type="text" name="subject" class="form-control" id="subjectInput" value="${trainertoupdate.subject}"/>
                </div>
