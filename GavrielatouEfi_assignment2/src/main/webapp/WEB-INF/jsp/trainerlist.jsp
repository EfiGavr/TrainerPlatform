                ...
                <thead>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><a class="btn" href="/trainer/update/${trainer.trainerId}" role="button">Update</a></td>
                            <td><a class="btn" href="/trainer/delete/${trainer.trainerId}" role="button">Delete</a></td>
                        </tr>
                    <tbody>
                    </c:forEach>
            </table>
