...
<%@page import="com.example.demo.service.TrainerServiceImpl"%>
...
<html>
    ...
    <body>
        ...
        <h1 class="header">Trainers Form</h1>
        <div class="container my-5">
            <font color="red">${errorMessage}</font>
            <form action="/trainer/insert" method="post">
                <div class="form-group">
                    <label for="firstNameInput">First Name</label>
                    <input type="text" name="firstname" class="form-control" id="firstNameInput" placeholder="First Name" aria-describedby="inputGroupPrepend" required>
                </div>
                <div class="form-group">
                    <div class="input-group has-validation">
                        <label for="lastNameInput">Last Name</label>
                        <input type="text" name="lastname"class="form-control" id="lastNameInput" placeholder="Last Name" aria-describedby="inputGroupPrepend" required>
                    </div>
                </div>
                <div class="form-group">
                    <div class="input-group has-validation">
                        <label for="subjectInput">Subject</label>
                        <input type="text" name="subject"class="form-control" id="subjectInput" placeholder="Subject" aria-describedby="inputGroupPrepend" required>
                    </div>
                </div>
                <input type="submit"/> 
        </div>
